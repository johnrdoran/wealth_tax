...
write.csv(results, "monte_carlo_results_v2.csv", row.names = FALSE)
cat("Results saved: monte_carlo_results_v2.csv\n")
...
for (K_report in c(300, 400, 500, 750, 1000, 1500, 2000)) {
